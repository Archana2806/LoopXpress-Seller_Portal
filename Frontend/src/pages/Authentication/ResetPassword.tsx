...
const ResetPassword: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const verifyToken = async () => {
      try {
        await axios.get(`https://loop-xpress-seller-portal.vercel.app/api/users/reset-password/${token}`);
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(`https://loop-xpress-seller-portal.vercel.app/api/users/reset-password/${token}`, {
