...
const ResetPassword: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const verifyToken = async () => {
      try {
        await axios.get(`${import.meta.env.BACKEND_BASEURL}/api/users/reset-password/${token}`);
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.BACKEND_BASEURL}/api/users/reset-password/${token}`, {
