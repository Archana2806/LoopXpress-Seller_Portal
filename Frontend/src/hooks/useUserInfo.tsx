...
const useUserInfo = () => {
  ...
  useEffect(() => {
    const fetchUserInfo = async () => {
      try {
        ...
        const response = await fetch(`${import.meta.env.BACKEND_BASEURL}/api/users/user-info`, {
          method: 'GET',
          headers: {
  ...
  const updatePersonalInfo = async (updatedDetails: any) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.BACKEND_BASEURL}/api/users/update-personal-info`, {
        method: 'PUT',
        headers: {
  ...
  const updateBusinessInfo = async (updatedDetails: any) => {
    try {
      ...
      const response = await fetch(`${import.meta.env.BACKEND_BASEURL}/api/users/update-business-info`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
